...
\graduacaoem{Redes de Computadores}
...
\titulo{ANÁLISE DE ESCALABILIDADE DE REDES LORAWAN PARA MONITORAMENTO DE OVINOS NO SERTÃO CENTRAL: UM ESTUDO POR SIMULAÇÃO COM CENÁRIOS DE CONFINAMENTO E PASTAGEM}
\data{2026}
\local{Quixadá}
...
\orientador{Prof. Dr. Antônio Rafael Braga}
\orientadories{Universidade Federal do Ceará (UFC)}
\orientadorcentro{Redes de Computadores}
